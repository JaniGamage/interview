  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Add new employee' , style: TextStyle(fontSize: 20 , color: Colors.black), textAlign: TextAlign.left),
        leading: IconButton(
          onPressed: (){
          ...
          Column(
            ...
            children: const [
              ...
              Padding(
                ...
                child: Text('Add employee' , style: TextStyle(fontSize: 30 , fontWeight: FontWeight.bold),),
              ),
              SizedBox(height: 30,),
              Padding(
            ...
            child: Container(
              ...
              child: TextButton(onPressed: (){
                if (_formKey.currentState!.validate()){
                  ...
                  child: const Text('Add' , style: TextStyle(color: Colors.white , fontSize: 30 , fontWeight: FontWeight.bold),)
              ),
            ),
          ),
          const SizedBox(height: 30,),
